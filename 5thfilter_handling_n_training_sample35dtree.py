...
param_grid = {
    ...
    'min_samples_leaf': [8, 15, 20, 25, 30]
}
...
train_sizes, train_scores, val_scores = learning_curve(
    MultiOutputRegressor(DecisionTreeRegressor(max_depth=7, min_samples_leaf=25)),
...
plt.plot(train_sizes, train_scores_mean, 'o-', label='Training RMSE', color='blue')
plt.fill_between(train_sizes, train_scores_mean - train_scores_std,
                 train_scores_mean + train_scores_std, alpha=0.2, color='blue')

plt.plot(train_sizes, val_scores_mean, 'o-', label='Validation RMSE', color='green')
